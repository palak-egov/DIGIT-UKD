...
import { CloseSvg, Localities, RemoveableTag, SubmitBar } from "@egovernments/digit-ui-react-components";
...
const FilterInbox = ({ searchParams, onFilterChange, defaultSearchParams, ...props }) => {
