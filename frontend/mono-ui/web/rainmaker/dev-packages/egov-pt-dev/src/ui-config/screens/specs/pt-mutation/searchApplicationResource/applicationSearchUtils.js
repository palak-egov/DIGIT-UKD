...
export const getPayload = (pASearchScreenObject) => {
  let querryObject = [];
  if (pASearchScreenObject) {
    if (pASearchScreenObject.ownerName) {
      querryObject.push({
        key: "name",
        value: pASearchScreenObject.ownerName,
      });
    }
    if (pASearchScreenObject.mobileNumber) {
      querryObject.push({
        key: "mobileNumber",
        value: pASearchScreenObject.mobileNumber,
      });
    }
    if (pASearchScreenObject.ids) {
      querryObject.push({ key: "propertyIds", value: pASearchScreenObject.ids });
    }
    if (pASearchScreenObject.locality) {
      querryObject.push({
        key: "locality",
        value: pASearchScreenObject.locality.code,
      });
    }
